document.addEventListener('DOMContentLoaded', function() {
    ...
    // Sample data
    const materials = [
        { id: 1, batchNo: 'B001', name: 'COFEED (CORN MEAL)', unit: 'kg', quantity: 89, inDate: '2023-05-01' },
        { id: 2, batchNo: 'B002', name: 'Rice Polish', unit: 'KG', quantity: 8, inDate: '2023-05-02' },
        { id: 3, batchNo: 'B003', name: 'FIBER DIGESTING', unit: 'KG', quantity: 5, inDate: '2023-05-03' },
        { id: 4, batchNo: 'B004', name: 'YEAST CULTURE(RUMIYEAST)', unit: 'KG', quantity: 1, inDate: '2023-05-04' },
        { id: 5, batchNo: 'B005', name: 'MAGNESIUM OXIDE', unit: 'KG', quantity: 5, inDate: '2023-05-05' },
    ];
    ...
    document.getElementById('manufacturingBtn').addEventListener('click', function() {
        window.location.href = 'manufacturing-material.html'; // Adjust this URL if needed
    });
